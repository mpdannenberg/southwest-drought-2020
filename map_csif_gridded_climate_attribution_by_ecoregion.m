...
T = table('Size',[6 7], 'VariableTypes',{'string','string','string','string','string','string','string'},...
    'VariableNames',{'Ecoregion','dCSIF_SMAP','dCSIF_All','dCSIF_PAR','dCSIF_SM','dCSIF_Tair','dCSIF_VPD'});
...
T.dCSIF_SMAP(1) = num2str(round(nanmean(CSIF_obs(ecoL2==10.1)), 4));
T.dCSIF_All(1) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_all(ecoL2==10.1)), CSIF_all_ci(1), CSIF_all_ci(2)); 
T.dCSIF_PAR(1) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_par(ecoL2==10.1)), CSIF_par_ci(1), CSIF_par_ci(2)); 
T.dCSIF_SM(1) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_sm(ecoL2==10.1)), CSIF_sm_ci(1), CSIF_sm_ci(2)); 
T.dCSIF_Tair(1) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_tair(ecoL2==10.1)), CSIF_tair_ci(1), CSIF_tair_ci(2)); 
T.dCSIF_VPD(1) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_vpd(ecoL2==10.1)), CSIF_vpd_ci(1), CSIF_vpd_ci(2)); 
...
T.dCSIF_SMAP(3) = num2str(round(nanmean(CSIF_obs(ecoL2==11.1)), 2));
T.dCSIF_All(3) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_all(ecoL2==11.1)), CSIF_all_ci(1), CSIF_all_ci(2)); 
T.dCSIF_PAR(3) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_par(ecoL2==11.1)), CSIF_par_ci(1), CSIF_par_ci(2)); 
T.dCSIF_SM(3) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_sm(ecoL2==11.1)), CSIF_sm_ci(1), CSIF_sm_ci(2)); 
T.dCSIF_Tair(3) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_tair(ecoL2==11.1)), CSIF_tair_ci(1), CSIF_tair_ci(2)); 
T.dCSIF_VPD(3) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_vpd(ecoL2==11.1)), CSIF_vpd_ci(1), CSIF_vpd_ci(2)); 
...
T.dCSIF_SMAP(2) = num2str(round(nanmean(CSIF_obs(ecoL2==10.2)), 2));
T.dCSIF_All(2) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_all(ecoL2==10.2)), CSIF_all_ci(1), CSIF_all_ci(2)); 
T.dCSIF_PAR(2) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_par(ecoL2==10.2)), CSIF_par_ci(1), CSIF_par_ci(2)); 
T.dCSIF_SM(2) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_sm(ecoL2==10.2)), CSIF_sm_ci(1), CSIF_sm_ci(2)); 
T.dCSIF_Tair(2) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_tair(ecoL2==10.2)), CSIF_tair_ci(1), CSIF_tair_ci(2)); 
T.dCSIF_VPD(2) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_vpd(ecoL2==10.2)), CSIF_vpd_ci(1), CSIF_vpd_ci(2)); 
...
T.dCSIF_SMAP(4) = num2str(round(nanmean(CSIF_obs(ecoL2==9.4)), 2));
T.dCSIF_All(4) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_all(ecoL2==9.4)), CSIF_all_ci(1), CSIF_all_ci(2)); 
T.dCSIF_PAR(4) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_par(ecoL2==9.4)), CSIF_par_ci(1), CSIF_par_ci(2)); 
T.dCSIF_SM(4) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_sm(ecoL2==9.4)), CSIF_sm_ci(1), CSIF_sm_ci(2)); 
T.dCSIF_Tair(4) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_tair(ecoL2==9.4)), CSIF_tair_ci(1), CSIF_tair_ci(2)); 
T.dCSIF_VPD(4) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_vpd(ecoL2==9.4)), CSIF_vpd_ci(1), CSIF_vpd_ci(2)); 
...
T.dCSIF_SMAP(5) = num2str(round(nanmean(CSIF_obs(ecoL2==13.1)), 2));
T.dCSIF_All(5) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_all(ecoL2==13.1)), CSIF_all_ci(1), CSIF_all_ci(2)); 
T.dCSIF_PAR(5) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_par(ecoL2==13.1)), CSIF_par_ci(1), CSIF_par_ci(2)); 
T.dCSIF_SM(5) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_sm(ecoL2==13.1)), CSIF_sm_ci(1), CSIF_sm_ci(2)); 
T.dCSIF_Tair(5) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_tair(ecoL2==13.1)), CSIF_tair_ci(1), CSIF_tair_ci(2)); 
T.dCSIF_VPD(5) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_vpd(ecoL2==13.1)), CSIF_vpd_ci(1), CSIF_vpd_ci(2)); 
...
T.dCSIF_SMAP(6) = num2str(round(nanmean(CSIF_obs(ecoL2==12.1)), 2));
T.dCSIF_All(6) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_all(ecoL2==12.1)), CSIF_all_ci(1), CSIF_all_ci(2)); 
T.dCSIF_PAR(6) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_par(ecoL2==12.1)), CSIF_par_ci(1), CSIF_par_ci(2)); 
T.dCSIF_SM(6) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_sm(ecoL2==12.1)), CSIF_sm_ci(1), CSIF_sm_ci(2)); 
T.dCSIF_Tair(6) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_tair(ecoL2==12.1)), CSIF_tair_ci(1), CSIF_tair_ci(2)); 
T.dCSIF_VPD(6) = sprintf('%.4f [%.4f, %.4f]', nanmean(CSIF_vpd(ecoL2==12.1)), CSIF_vpd_ci(1), CSIF_vpd_ci(2)); 
